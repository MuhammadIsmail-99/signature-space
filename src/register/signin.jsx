...
const SigninForm = ({ onNavigate }) => {
  ...
  useEffect(() => {
    const savedUserData = localStorage.getItem("userAuthData")
    if (savedUserData) {
  ...
  const handleSubmit = (e) => {
    ...
    if (savedUserData) {
      ...
      if (loginMethod === "email") {
        if (userData.email === formData.emailOrUsername || userData.username === formData.emailOrUsername) {
          console.log("User signed in:", formData)
          alert("Welcome back!")
          return
        }
      } else {
        if (userData.phoneNumber === formData.phoneNumber) {
          console.log("User signed in with phone:", formData.phoneNumber)
  ...
  const handleWhatsAppSignin = () => {
    ...
    console.log("WhatsApp signin with:", formData.phoneNumber)
    alert("WhatsApp verification sent!")
  }
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <button type="submit" className="auth-button primary">
              {loginMethod === "email" ? "Sign In" : "Send WhatsApp Code"}
            </button>
          </form>
          ...
          <div className="social-buttons">
            <button className="social-button whatsapp" onClick={handleWhatsAppSignin}>
